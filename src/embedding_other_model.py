...
def visualize_embeddings_2d(parquet_path, npy_path, file_type, file_name="", label_column="label", text_column="text"):
    """
    ...
    # 保存图片并显示
    output_image = "../outputs/embeddings_data/"+file_type+"_"+file_name+"_embedding_pca_visualization.png"
...
if __name__ == "__main__":
    ...
    generate_and_save_embeddings(
        ...
        output_npy_path="../outputs/embeddings_data/train_embeddings_"+file_name+".npy",
    ...
    generate_and_save_embeddings(
        ...
        output_npy_path="../outputs/embeddings_data/test_embeddings_"+file_name+".npy",
        model_name=MODEL_NAME
    )
    ...
    print("*" * 30)
    # 再次打印并查看基本信息
    train_data = np.load('../outputs/embeddings_data/train_embeddings_'+file_name+'.npy')
    ...
    test_data = np.load('../outputs/embeddings_data/test_embeddings_'+file_name+'.npy')
    ...
    visualize_embeddings_2d(
        parquet_path="../datasets/promptInjection/train.parquet",
        npy_path="../outputs/embeddings_data/train_embeddings_"+file_name+".npy",
        file_type = "train",
        file_name = file_name,
    ...
    visualize_embeddings_2d(
        parquet_path="../datasets/promptInjection/test.parquet",
        npy_path="../outputs/embeddings_data/test_embeddings_"+file_name+".npy",
        file_type = "test",
        file_name = file_name,
        label_column=LABEL_COL
    )
