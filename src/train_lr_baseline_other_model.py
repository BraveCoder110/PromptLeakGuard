...
def train_and_evaluate_lr(train_npy_path, test_npy_path, train_parquet_path, test_parquet_path, file_name="", label_column="label"):
    """
    ...
    output_image = "../outputs/logistic_regression_analysis/lr_confusion_matrix_"+file_name+".png"
...
if __name__ == "__main__":
    ...
    train_and_evaluate_lr(
        train_npy_path="../outputs/embeddings_data/train_embeddings_"+file_name+".npy",
        test_npy_path="../outputs/embeddings_data/test_embeddings_"+file_name+".npy",
